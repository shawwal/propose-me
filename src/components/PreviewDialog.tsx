  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[100vw] w-[100vw] h-[100vh] p-0 gap-0 rounded-none">
        <VisuallyHidden>
          <DialogTitle>Proposal Preview for {companyName}</DialogTitle>
          <DialogDescription>
            Review your proposal slides and PDF document before sharing or downloading
          </DialogDescription>
        </VisuallyHidden>
        {/* Custom Header */}
                      ...
                      <div className="grid grid-cols-4 gap-4 mt-8">
                        {['Q1: Planning', 'Q2: Launch', 'Q3: Scale', 'Q4: Optimize'].map((phase, idx) => (
                          <div key={idx} className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-lg p-4 border border-primary/20">
                            <div className="h-8 w-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center mb-3 text-sm">
                              {idx + 1}
                            </div>
                    ...
                    <div className="text-center space-y-8">
                      ...
                      <div className="mt-12 space-y-6">
                        <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
                          <h3 className="text-foreground text-xl mb-3">Let's schedule a call</h3>
              ...
              <div className="w-full max-w-4xl bg-white shadow-2xl">
                ...
                <div className="p-16 space-y-12">
                  ...
                  <section className="space-y-4">
                    <h2 className="text-foreground text-3xl pb-3 border-b-2 border-primary/20">
                      Executive Summary
                    </h2>
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="grid grid-cols-3 gap-6 mt-6">
                      <div className="bg-primary/5 rounded-lg p-6 border border-primary/10">
                        <div className="text-3xl text-primary mb-2">$2.5B+</div>
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="text-foreground text-xl mb-2">Strategic Collaboration</h3>
                      ...
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="text-foreground text-xl mb-2">Go-to-Market Synergies</h3>
                          <p className="text-muted-foreground leading-relaxed">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="text-foreground text-xl mb-2">Resource Sharing</h3>
                          <p className="text-muted-foreground leading-relaxed">
                      ...
                      <div className="flex gap-4">
                        ...
                        <div>
                          <h3 className="text-foreground text-xl mb-2">Innovation Pipeline</h3>
                          <p className="text-muted-foreground leading-relaxed">
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-lg">
                        <div className="px-3 py-1 bg-primary text-primary-foreground rounded text-sm shrink-0">Q1</div>
                        <div>
                          <div className="text-foreground mb-1">Planning & Setup</div>
                      ...
                      <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-lg">
                        <div className="px-3 py-1 bg-primary text-primary-foreground rounded text-sm shrink-0">Q2</div>
                        <div>
                          <div className="text-foreground mb-1">Program Launch</div>
                          <div className="text-sm text-muted-foreground">
                      ...
                      <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-lg">
                        <div className="px-3 py-1 bg-primary text-primary-foreground rounded text-sm shrink-0">Q3</div>
                        <div>
                          <div className="text-foreground mb-1">Scale & Optimize</div>
                          <div className="text-sm text-muted-foreground">
                      ...
                      <div className="flex items-start gap-4 p-4 bg-muted/30 rounded-lg">
                        <div className="px-3 py-1 bg-primary text-primary-foreground rounded text-sm shrink-0">Q4</div>
                        <div>
                          <div className="text-foreground mb-1">Results & Expansion</div>
                          <div className="text-sm text-muted-foreground">
                  ...
                  <section className="space-y-4">
                    ...
                    <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-xl p-8 border-2 border-primary/20">
                      <h3 className="text-foreground text-xl mb-4">We're Ready to Move Forward</h3>
        ...
        {/* Fullscreen hint */}
        <div className="h-12 border-t border-border bg-muted/30 flex items-center justify-center px-6 shrink-0">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <Maximize2 className="h-3 w-3" />
            <span>Press F11 for fullscreen mode (recommended for presentations)</span>
          </div>
        </div>
      </DialogContent>
    </Dialog>
